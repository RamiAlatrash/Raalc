...
const FeatureCard = ({ icon, title, description, delay }) => (
  ...
  >
    ...
    <h3 className="text-xl text-primary mb-2 font-arabic">{title}</h3>
    <p className="text-sm text-brand-dark-grey leading-relaxed font-arabic">{description}</p>
  </motion.div>
);
  ...
  return (
    <SectionWrapper id={id} dir="rtl" className="futuristic-determination-bg overflow-hidden">
      <div className="container mx-auto px-4 text-center">
        ...
        <motion.p 
          className="text-lg md:text-xl text-brand-dark-grey mb-12 max-w-3xl mx-auto font-arabic text-center"
          initial={{ opacity:0, y: -20}}
          whileInView={{ opacity:1, y:0}}
          viewport={{once: true}}
        ...
        >
          ...
          <h3 className="text-2xl text-primary mb-3 font-arabic">{determinationDataAr.approach.title}</h3>
          <p className="text-brand-dark-grey leading-relaxed font-arabic">
