    ...
    >
      ...
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center z-10 relative">
        ...
        <motion.div
          ...
          className="relative p-1 md:p-2 flex justify-center items-center min-h-[400px] order-1 md:order-1"
        >
          <img
        ...
        <motion.div
          ...
          className="px-4 md:px-8 order-2 md:order-2"
        >
          <div className="flex items-center mb-6">
            <img
              src="/images/robot-images/robot1.png"
              alt="تميمة الروبوت"
              className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 mr-3 sm:mr-4 ltr-preserve"
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-0 mt-20 relative w-full ltr-preserve" style={{ minHeight: '140px' }}>
            <a
              href="https://api.whatsapp.com/send/?phone=971564044137&text=Welcome%20to%20RAALC.%20Get%20your%20virtual%20token%20now"
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 min-w-[340px] pr-12 bg-gradient-to-r from-primary to-secondary text-white rounded-full shadow-lg text-xl font-heading font-bold hover:scale-105 transition-transform border-2 border-primary relative z-10 font-arabic rtl-text w-full md:w-auto text-center"
              style={{ boxShadow: '0 4px 16px rgba(56,189,248,0.18)', marginRight: '-1.25rem' }}
            >
              احصل على التوكن الرقمي الخاص بك الآن
            </a>
            <div className="relative w-24 h-32 sm:w-28 sm:h-36 md:w-32 md:h-40 flex flex-col items-center animate-robot-float z-20 ltr-preserve" style={{ marginLeft: '-1.25rem', marginBottom: '-1.5rem' }}>
              ...
              <div className="absolute -top-10 sm:-top-12 left-1/2 transform -translate-x-1/2 z-20 animate-speech-bubble-pop pointer-events-none">
                <div className="bg-white text-primary px-4 sm:px-6 py-2 rounded-full shadow-lg text-sm sm:text-base font-arabic border border-primary whitespace-nowrap rtl-text">
                  !دعنا نوصلك
                </div>
              </div>
              {/* Thought Dots, closer to the robot's head */}
              <div className="flex flex-col items-center absolute -top-3 sm:-top-4 left-1/2 transform -translate-x-1/2 z-10 space-y-1 ltr-preserve">
              ...
              <img
                ...
                alt="روبوت الهيرو"
                className="w-40 h-40 sm:w-48 sm:h-48 md:w-52 md:h-52 mt-6 sm:mt-8 md:mt-10 -mr-2 sm:-mr-3 md:-mr-4 ltr-preserve"
                aria-hidden="true"
              />
            </div>
          </div>
