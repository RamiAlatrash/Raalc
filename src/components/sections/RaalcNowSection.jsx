...
const raalcNowData = {
  ...
  "items": [
    ...
    },
    {
      ...
      "description": "Aladheed AlRashidiya is proud to be associated with Dubai Courts, providing authorized and licensed judicial services. Our partnership ensures that you receive official, reliable, and legally valid services for all your requirements.",
      "list": [
  ...
  return (
    ...
    <div className="container mx-auto px-4 relative z-10">
      ...
      <div className="flex justify-center items-center gap-4 mb-4">
        ...
        >
          Aladheed AlRashidiya Now <span className="block sm:inline">Submissions are</span><br className="hidden sm:block" /> Simplified with <span className="gradient-text-blue">Online Token</span>
        </motion.h2>
      ...
      <div className="space-y-8 mt-8">
          <RaalcNowItem
            ...
            altText="Aladheed AlRashidiya Smart Judicial Service Center digital interface"
        ...
        <div className="grid md:grid-cols-2 gap-6">
            <RaalcNowItem
              ...
              altText="Aladheed AlRashidiya's partnership with Dubai Courts"
            ...
            <RaalcNowItem
              ...
              altText="Aladheed AlRashidiya's efficient service delivery system"
