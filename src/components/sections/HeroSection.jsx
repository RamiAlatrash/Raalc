  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center z-10 relative">
        {/* Left Side: Headline, description, robot group, and original buttons */}
        <motion.div
        ...
        >
          <div className="flex items-center mb-6">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-heading text-primary leading-tight">
              Revolutionize <span className="block">Your Business</span> with <span className="gradient-text-blue">AI Intelligence</span>
            </h1>
          </div>
          <p className="text-lg md:text-xl text-brand-dark-grey mb-8 font-body">
        ...
        {/* Right Side: Only the main hero image */}
        <motion.div
