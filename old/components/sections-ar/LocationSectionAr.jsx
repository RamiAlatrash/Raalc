  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <motion.h2
          className="text-3xl sm:text-4xl md:text-5xl font-heading text-center mb-8 text-primary font-arabic"
        ...
        <motion.p
          className="text-lg md:text-xl text-brand-dark-grey text-center mb-12 max-w-3xl mx-auto font-arabic"
          initial={{ opacity: 0, y: -20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5, delay: 0.2 }}
        >
          تفضل بزيارتنا في موقعنا المناسب في قلب دبي. ونتطلع إلى الترحيب بكم.
        </motion.p>
