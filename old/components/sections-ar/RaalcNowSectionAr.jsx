    ...
    >
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex justify-center items-center gap-4 mb-4">
          <img src="/images/robot-images/robot1.png" alt="روبوت 1" className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24" />
          <img src="/images/robot-images/robot12.png" alt="روبوت 12" className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24" />
          <img src="/images/robot-images/robot17.png" alt="روبوت 17" className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24" />
        </div>

        <motion.h2 
          className="text-3xl sm:text-4xl md:text-5xl font-heading text-center mb-4 text-primary font-arabic"
