  ...
  return (
    ...
    >
      <img
        ...
        alt=""
        className="absolute bottom-0 left-0 w-40 opacity-10 blur-sm pointer-events-none select-none"
        aria-hidden="true"
      />
      <div className="container mx-auto px-4">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading text-center mb-4 text-primary font-arabic">ماذا يقول عملاؤنا</h2>
